...
export type CatalogOverview = { database: string | null, namespaces: Array<string>, relations: Array<CatalogOverviewRelation>, detailState: CatalogOverviewDetailState, };
