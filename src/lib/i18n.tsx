...
const messages = {
  en: {
    ...
    "schema.erdLayoutLimit":
      "Automatic layout is limited to {limit} visible objects. Filter the schema or use neighborhood mode first.",
  ...
  ko: {
    ...
    "schema.erdLayoutLimit":
      "자동 레이아웃은 현재 보이는 객체 {limit}개까지 지원합니다. 먼저 검색 필터나 주변 보기로 범위를 줄이세요.",
