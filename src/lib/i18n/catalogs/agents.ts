...
export const agentsCatalog = defineCatalog(
  {
    ...
    "agent.acpEmptyBody":
      "Codex works through the official Agent Client Protocol while this screen streams its plan, tool calls, permission requests, and results.",
    "agent.acpEmptyTitle": "Start a connection-pinned Agent",
    ...
    "agent.acpLocalAuth":
      "Authentication stays in your local Codex login. DopeDB never reads or stores its token.",
    "agent.acpNew": "New Agent session",
    ...
    "agent.acpProtocol": "ACP v1 · official Codex adapter",
    "agent.acpReadyBody":
    ...
    "agent.acpResumeBody":
      "This bounded history is stored locally. Resume it through the official Codex adapter.",
    ...
    "agent.acpStartCodex": "Start Codex Agent",
    "agent.acpStartFailed": "Could not start Codex through ACP: {error}",
    "agent.acpStarting": "Starting the official Codex ACP adapter…",
    "agent.acpThought": "Agent progress",
    "agent.acpTitle": "Agent",
  ...
  },
  {
    ...
    "agent.acpEmptyBody":
      "Codex는 공식 Agent Client Protocol로 일하며, 이 화면은 계획·도구 호출·권한 요청·결과를 실시간으로 보여줍니다.",
    "agent.acpEmptyTitle": "연결에 고정된 Agent 시작",
    ...
    "agent.acpLocalAuth":
      "인증은 사용자의 로컬 Codex 로그인이 소유합니다. DopeDB는 토큰을 읽거나 저장하지 않습니다.",
    "agent.acpNew": "새 Agent 세션",
    ...
    "agent.acpStartCodex": "Codex Agent 시작",
    "agent.acpStartFailed": "ACP로 Codex를 시작하지 못했습니다: {error}",
    "agent.acpStarting": "공식 Codex ACP 어댑터를 시작하는 중…",
