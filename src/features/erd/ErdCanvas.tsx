...
import { saveErdLayout } from "./tauriAdapter";
...
export default function ErdCanvas({
  ...
  const [compact, setCompact] = useState(
    relationCount > AUTO_COMPACT_THRESHOLD,
  );
  ...
  useEffect(() => {
    ...
    setCompact(relationCount > AUTO_COMPACT_THRESHOLD);
    setNeighborhood(relationCount > AUTO_COMPACT_THRESHOLD);
    setVirtualRelations([]);
    setDirty(false);
    void autoLayout();
  }, [
