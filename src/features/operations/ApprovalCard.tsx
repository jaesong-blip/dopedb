...
export default function ApprovalCard({
  ...
  const autoRunProposalId = useRef<string | null>(null);
  ...
  const proposalOperationId = proposal?.operationId ?? null;
  ...
  }, [confirmation, onExecuted, proposal]);
  ...
  useEffect(() => {
    if (
      ...
      autoRunProposalId.current === proposalOperationId
    ) {
      return;
    }
    autoRunProposalId.current = proposalOperationId;
    void execute();
  }, [busy, canAutoRun, decided, execute, proposalOperationId]);
