...
export default function TerminalDock({
  ...
  return (
    <>
      ...
      >
        <div
          className="tw:absolute tw:inset-y-0 tw:-left-[3px] tw:z-[var(--ds-z-raised)] tw:w-[7px] tw:cursor-col-resize tw:hover:bg-ring/30 tw:active:bg-ring/30 tw:data-[layout=overlay]:hidden tw:data-[layout=compact]:hidden tw:data-[layout=maximized]:hidden"
          data-layout={dockLayout}
          role="separator"
