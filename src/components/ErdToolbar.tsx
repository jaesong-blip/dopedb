...
export default function ErdToolbar({
  ...
  return (
    <div className="erd-toolbar ds-toolbar ds-control-row">
      ...
      <button
        className={`btn small${compact ? " active" : ""}`}
        type="button"
      ...
      <button
        className={`btn small${neighborhood ? " active" : ""}`}
        type="button"
      ...
      {dirty && <span className="badge">{t("schema.erdUnsaved")}</span>}
      <button
      ...
      <details className="toolbar-menu">
        <summary
          className="btn small"
          title={t("schema.erdExport")}
          aria-label={t("schema.erdExport")}
        >
          <Icon name="download" />
        </summary>
        <div className="toolbar-menu-panel erd-export-menu">
