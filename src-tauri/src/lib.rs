...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            features::terminals::transport::skill_setup_terminal_create,
            features::terminals::transport::skill_setup_terminal_write,
            features::terminals::transport::skill_setup_terminal_draft,
            features::terminals::transport::skill_setup_terminal_resize,
            features::terminals::transport::skill_setup_terminal_close,
