...
type NeonBranchManagedAccessRow = {
  id: string;
  state: string;
  planHash: string;
  ownershipMarker: string;
...
function bootstrapResultProjection(
  value: unknown,
  branchId: string,
): Pick<
...
function neonBranchManagedAccessBoundary(
...
type NeonBranchSwitchCompletionRow = {
  operationId: string;
  connectionId: string;
